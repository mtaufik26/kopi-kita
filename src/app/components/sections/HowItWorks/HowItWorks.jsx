...
export default function HowItWorks() {
  return (
    <section className="relative py-16 sm:py-20 md:py-28 bg-[#0f0f0f] overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold">
            <span className="text-white">Cara Menikmati</span>
            <br />
            <span className="text-gradient-gold">Kopi Kita</span>
          </h2>

          <p className="text-gray-400 max-w-xl mx-auto mt-4 text-sm sm:text-base">
            Gak ribet, tinggal pilih dan nikmati
          </p>
        </motion.div>
        ...
        >
          {STEPS.map((step) => (
            <motion.div key={step.id} variants={card} className="relative">
              ...
              <Card className="group bg-black/40 backdrop-blur-sm border border-white/10 shadow-xl shadow-black/40 hover:border-gold/40 transition-all duration-500 hover:-translate-y-2 rounded-2xl h-full">
        ...
        >
          <p className="text-xs text-gray-500">
            Bisa langsung datang atau order lewat aplikasi favoritmu
          </p>
        </motion.div>
